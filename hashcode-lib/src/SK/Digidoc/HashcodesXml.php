...
class HashcodesXml
{
    ...
    {
        $fullPathAttribute = self::FILE_ENTRY_ELEMENT_ATTRIBUTE_FULL_PATH;
    ...
    {
        $elem->addAttribute(self::FILE_ENTRY_ELEMENT_ATTRIBUTE_FULL_PATH, $hashcodesFileEntry->getFullPath());
        $elem->addAttribute(self::FILE_ENTRY_ELEMENT_ATTRIBUTE_HASH, $hashcodesFileEntry->getHash());
        $elem->addAttribute(self::FILE_ENTRY_ELEMENT_ATTRIBUTE_SIZE, $hashcodesFileEntry->getSize());
    }
